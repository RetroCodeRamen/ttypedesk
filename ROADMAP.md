...
- [ ] **BridgeSurface** + pluggable backends
- [ ] **BrowserNest** — nested/headless browser (first vertical for “web” if desired)
- [ ] **DisplayNest** — Xvfb/Wayland nest for arbitrary GUI apps
- [ ] **RemoteNest** — RDP/VNC decode into the same path
- [ ] App/desktop manifests can launch bridge targets (with whatever icon the user picks)
- [ ] Perf: overscan buffer, frame budget
