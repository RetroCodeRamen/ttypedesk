...
import (
	...
	"github.com/RetroCodeRamen/ttypedesk/apps/addprog"
	...
	"github.com/RetroCodeRamen/ttypedesk/apps/imageview"
	"github.com/RetroCodeRamen/ttypedesk/apps/manual"
	"github.com/RetroCodeRamen/ttypedesk/apps/mgrprog"
	"github.com/RetroCodeRamen/ttypedesk/apps/notes"
	"github.com/RetroCodeRamen/ttypedesk/apps/settings"
...
func (s *Server) launchAction(action string) error {
	...
	case "chat":
		return s.FocusOrCreateApp("chat", "Chat")
	default:
